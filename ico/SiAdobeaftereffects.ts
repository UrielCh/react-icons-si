...
/**
 * Adobeaftereffects icon from Simple Icons
 * @module
 */
export function SiAdobeaftereffects(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default SiAdobeaftereffects;
