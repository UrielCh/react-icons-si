...
/**
 * Apacheopenoffice icon from Simple Icons
 * @module
 */
export function SiApacheopenoffice(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default SiApacheopenoffice;
