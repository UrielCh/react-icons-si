...
/**
 * Adobepremierepro icon from Simple Icons
 * @module
 */
export function SiAdobepremierepro(props: IconBaseProps): VNode<JSX.SVGAttributes> {
...
export default SiAdobepremierepro;
