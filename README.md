...
```json
{
  "imports": {
    ...
    "preact/": "https://esm.sh/preact@10.15.1/",
    "react-icons/si":  "https://cdn.jsdelivr.net/gh/urielch/react-icons-si@1.0.5/mod.ts",
    "react-icons/si/": "https://cdn.jsdelivr.net/gh/urielch/react-icons-si@1.0.5/ico/",
  }
}
```
...
```ts
import { Si1001Tracklists } from "https://deno.land/x/react_icons_si@1.0.5/mod.ts"
```
